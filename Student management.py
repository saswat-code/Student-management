...
def Connectdb():
    def submitdb():
        ...
        try:
            ...
            messagebox.showerror('Notifications','Invalid login details please try again',parent=dbroot)
            return
        try:
    ...
    dbroot = Toplevel()
    dbroot.grab_set()
    dbroot.geometry('470x250+900+230')
...
addbtn = Button(DataEntryFrame,text='1. Add Student',width=25,font=('calibri',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=addstudent)
addbtn.pack(side=TOP,expand=True)

searchbtn = Button(DataEntryFrame,text='2. Search Student',width=25,font=('calibri',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=searchstudent)
searchbtn.pack(side=TOP,expand=True)

deletebtn = Button(DataEntryFrame,text='3. Delete Student',width=25,font=('calibri',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=deletestudent)
deletebtn.pack(side=TOP,expand=True)

updatebtn = Button(DataEntryFrame,text='4. Update Student',width=25,font=('calibri',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=updatestudent)
updatebtn.pack(side=TOP,expand=True)

showallbtn = Button(DataEntryFrame,text='5. Show All',width=25,font=('calibri',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=showstudent)
showallbtn.pack(side=TOP,expand=True)

exportbtn = Button(DataEntryFrame,text='6. Export data',width=25,font=('calibri',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
                activeforeground='white',command=exportstudent)
exportbtn.pack(side=TOP,expand=True)

exitbtn = Button(DataEntryFrame,text='7.  Exit',width=25,font=('calibri',20,'bold'),bd=6,bg='skyblue3',activebackground='blue',relief=RIDGE,
...
##-------------------------------------------------  Showdataframe
style = ttk.Style()
style.configure('Treeview.Heading',font=('calibri',20,'bold'),foreground='blue')
...
text = ''
##################################
SliderLabel = Label(root,text=ss,font=('calibri',20,'italic bold'),relief=RIDGE,borderwidth=4,width=39,bg='cyan')
...
connectbutton = Button(root,text='Connect To Database',width=23,font=('calibri',15,'italic bold'),relief=RIDGE,borderwidth=4,bg='green2',
